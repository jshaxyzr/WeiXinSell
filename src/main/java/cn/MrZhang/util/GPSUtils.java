...
public class GPSUtils {
     ...
     */
    public static double getDistance(double srcLatitude, double srcLongitude, double destLatitude, double destLongitude) {
     ...
     * 
    		...
    		*@param destLongitude	目的经度，单位弧度
     */
    public static double getDistance(String srcLatitude, String srcLongitude, String destLatitude, String destLongitude) {
        if (StringUtils.isEmpty(srcLatitude) || StringUtils.isEmpty(srcLongitude) || StringUtils.isEmpty(destLatitude)
