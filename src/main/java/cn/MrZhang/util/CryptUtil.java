...
public class CryptUtil {
    ...
    public static void main(String[] args) throws Exception {
        String content = "dev";
        String dcontent = CryptUtil.encryptAES(content, CryptUtil.DEFAULT_SECRET_KEY);
        System.out.println(dcontent);
        System.out.println(CryptUtil.decryptAES(dcontent, CryptUtil.DEFAULT_SECRET_KEY));
    }
}
